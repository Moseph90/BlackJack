...
//GameSetUp.cpp are all cpp files of this header file. It contains all the functions 
//that the game uses. You may find some of the definitions of these functions in 
//GameBetting.cpp, GameCards.cpp, GameSetup.cpp as well as Game.cpp. Remember they all 
//share from this class. It's just separated so that there arent 10,000 lines of code in 
//one file. FYI, all of the functions and variables that start with SDL_ are SDL specific 
//keywords and are not mine. Everything else is custom. I hope that helps.
//****************************************************************************************
